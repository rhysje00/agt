#############################################################################
##
#W  codegrph.gi          Algebraic Graph Theory package         Janoš Vidali
##
##
#Y  Copyright (C) 2020
##
##  Implementation file for functions that construct code graphs.
##  
##
...
InstallGlobalFunction( PreparataGraph,
function(arg)
  local j, filt;
